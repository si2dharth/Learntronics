...
public class Tutorial1 : Tutorial {
    ...
    public Tutorial1() {
        ...
        addSymbol(batt);
        addSymbol(lamp);
        res1.transform.position = new Vector2(-1, 2);
        res2.transform.position = new Vector2(1, 2);
        ...
        res1.connectTo(1, res2);

        res2.connectTo(2, res1);
    ...
    {
        CanvasScript.canvas.ShowInfo("Drag the components onto corresponding symbols to create a series circuit.");
    }
}
